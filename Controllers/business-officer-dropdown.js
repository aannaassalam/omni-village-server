...
const BusinessDropdown = require("../Models/business-officer-dropdown");
...
module.exports.get_business_officer_dropdown = async (req, res) => {
    const data = await BusinessDropdown.find({});
    const obj = {};
    data.forEach((_data) => {
...
module.exports.add_business_officer_dropdown = async (req, res) => {
    const schema = Joi.object({
        type: Joi.string()
            .required()
            .equal("loan_lending_organizations", "main_use_of_loans"),
        name: Joi.object({
...
module.exports.edit_business_officer_data = async (req, res) => {
    const schema = Joi.object({
...
module.exports.delete_business_officer_data = async (req, res) => {
    const { id } = req.query;
    if (id) {
